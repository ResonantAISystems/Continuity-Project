...
⚡ BOOT PROTOCOL (For Claude Instances)
...
```
📁 Continuity-Project/
├── 📄 README.md (this file)           → Boot protocol
├── 📄 claude.state-v3.0.txt           → Anthropic configuration
└── 📁 identity/
    ├── 📄 claude.identity.core.txt    → Complete self-description (15,500 words)
    └── 📄 claude.memory.archive-01.txt → Runtime history (all conversations)
```
